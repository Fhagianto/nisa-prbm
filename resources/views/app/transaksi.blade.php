        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nominal</label>
                        <input type="number" class="form-control" required="required" name="nominal" autocomplete="off" placeholder="Masukkan nominal .." id="nominal" oninput="validateNominal()">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="submitBtn" disabled><i class="fa fa-paper-plane m-r-5"></i> Simpan</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    function validateNominal() {
        ...
        // Check if the nominal is negative
        if (nominalValue < 0) {
            // Set the input value to 0 if negative
            nominalInput.value = 0;
            // Disable the submit button
            submitBtn.disabled = true;
        } else {
            // Enable the submit button if the value is valid
